          ...
          <button 
            ...
            onClick={() => {
                if(confirm('Deletar esse post permanentemente?')) {
                    api.delete(`/posts/${postId}`).then(() => router.push('/main/posts'));
                }
            }}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Título do Artigo</label>
              <Input 
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 bg-muted/30 px-3 rounded-lg border border-border">
                <span className="text-muted-foreground text-xs whitespace-nowrap font-mono">/blog/</span>
                <input 
          ...
          {/* Card: Resumo */}
          <div className="bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
            <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Resumo / Excerpt</label>
            <textarea 
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border rounded-2xl shadow-sm p-6 space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Categoria</label>
              <select 
                className="w-full h-10 px-3 rounded-lg border border-border bg-background text-sm outline-none focus:ring-2 focus:ring-primary/20"
          ...
          <div className="bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
            ...
            <div className="space-y-2">
                <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Nome do Autor</label>
                <Input 
